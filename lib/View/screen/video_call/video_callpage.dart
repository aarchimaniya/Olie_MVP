...
import '../Chat_Screen/chat_screenpage.dart';
import '../VideoCall_Discconect/call_dieconnectpage.dart';
          ...
          Row(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                child: Text(
                  'Sports Mode',
                  style: TextStyle(color: const Color(0xFFACACAC)),
                ),
              ),
              CircleAvatar(
                backgroundColor: const Color(0xFF262626),
